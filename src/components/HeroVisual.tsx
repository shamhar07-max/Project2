...
export default function HeroVisual() {
  return (
    <div className="relative mx-auto aspect-square w-full max-w-md lg:max-w-lg">
      {/* soft ambient blobs */}
      <div className="absolute -top-10 -right-10 h-56 w-56 rounded-full bg-white/10 blur-3xl" aria-hidden />
      <div className="absolute -bottom-14 -left-10 h-64 w-64 rounded-full bg-red/10 blur-3xl" aria-hidden />
